...
//       {/* Main Content */}
//       <main className="px-4 sm:px-6 lg:px-2 min-h-[calc(100vh-5rem)]">
//         <div className="max-w-screen mx-auto h-full">
//           <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-0 h-full">
//             <div className="lg:col-span-4 flex flex-col gap-10 pt-20">
